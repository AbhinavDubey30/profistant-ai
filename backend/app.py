...
def get_fallback_papers(topic):
    ...
    fallback_papers = [
        {
            "title": f"Attention Is All You Need - {topic} Applications",
        ...
        {
            "title": f"BERT: Pre-training of Deep Bidirectional Transformers for {topic}",
        ...
        {
            "title": f"ResNet: Deep Residual Learning for {topic} Recognition",
        ...
        {
            "title": f"Generative Adversarial Networks for {topic}",
        ...
        {
            "title": f"Deep Learning for {topic}: A Comprehensive Survey",
